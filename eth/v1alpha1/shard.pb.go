...
func (m *ShardTransitionCandidate) Reset()         { *m = ShardTransitionCandidate{} }
func (m *ShardTransitionCandidate) String() string { return proto.CompactTextString(m) }
...
func (m *ShardTransitionCandidate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ShardTransitionCandidate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ShardTransitionCandidate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ShardTransitionCandidate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShardTransitionCandidate.Merge(m, src)
}
func (m *ShardTransitionCandidate) XXX_Size() int {
	return m.Size()
}
func (m *ShardTransitionCandidate) XXX_DiscardUnknown() {
	xxx_messageInfo_ShardTransitionCandidate.DiscardUnknown(m)
}

var xxx_messageInfo_ShardTransitionCandidate proto.InternalMessageInfo

func (m *ShardTransitionCandidate) GetStartSlot() uint64 {
	if m != nil {
		return m.StartSlot
	}
	return 0
...
func (m *ShardTransitionCandidate) GetShardBlockLengths() []uint64 {
	if m != nil {
		return m.ShardBlockLengths
	}
	return nil
...
func (m *ShardTransitionCandidate) GetShardDataRoots() [][]byte {
	if m != nil {
		return m.ShardDataRoots
	}
	return nil
...
func (m *ShardTransitionCandidate) GetShardStates() []*ShardState {
	if m != nil {
		return m.ShardStates
	}
	return nil
...
func (m *ShardTransitionCandidate) GetProposerSignatureAggregate() []byte {
	if m != nil {
		return m.ProposerSignatureAggregate
	}
	return nil
...
type CompactCommittee struct {
	PubKeys              [][]byte `protobuf:"bytes,1,rep,name=pub_keys,json=pubKeys,proto3" json:"pub_keys,omitempty" ssz-size:"?,48" ssz-max:"2048"`
...
func init() {
	...
	proto.RegisterType((*ShardTransitionCandidate)(nil), "ethereum.eth.v1alpha1.ShardTransitionCandidate")
...
var fileDescriptor_5d9da510e571288b = []byte{
	...
	,
}
...
func (m *ShardTransitionCandidate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ShardTransitionCandidate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ShardTransitionCandidate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ShardBlockLengths) > 0 {
		dAtA5 := make([]byte, len(m.ShardBlockLengths)*10)
		var j4 int
		for _, num := range m.ShardBlockLengths {
			for num >= 1<<7 {
...
func (m *CompactCommittee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CompactValidators) > 0 {
		dAtA7 := make([]byte, len(m.CompactValidators)*10)
		var j6 int
...
func (m *ShardTransitionCandidate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ShardTransitionCandidate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardTransitionCandidate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardTransitionCandidate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
