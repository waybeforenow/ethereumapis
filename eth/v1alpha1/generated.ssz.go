...
func (s *ShardTransition) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ShardDataRoots'
	s.ShardDataRoots = make([][]byte, 12)
	for ii := 0; ii < 12; ii++ {
		s.ShardDataRoots[ii] = append(s.ShardDataRoots[ii], buf[12:396][ii*32:(ii+1)*32]...)
	}

	// Offset (3) 'ShardStates'
	if o3 = ssz.ReadOffset(buf[396:400]); o3 > size || o1 > o3 {
		return ssz.ErrOffset
	}

	// Field (4) 'ProposerSignatureAggregate'
	s.ProposerSignatureAggregate = append(s.ProposerSignatureAggregate, buf[400:496]...)
